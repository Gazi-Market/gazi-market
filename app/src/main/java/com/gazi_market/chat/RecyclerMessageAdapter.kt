...
import com.gazi_market.databinding.ListTalkItemMineBinding
import com.gazi_market.databinding.ListTalkItemOthersBinding
            ...
            .addSnapshotListener { snapshot, exception ->
                ...
                if (snapshot != null) {
                    ...
                    for (documentChange in snapshot.documentChanges) {
                        ...
                        val message = document.toObject(Message::class.java)
                        val messageKey = document.id

                        val currentTimestamp = message.sended_date
                        ...
                        when (documentChange.type) {
                            ...
                            // ADDITIONAL CASES FOR MODIFIED, REMOVED IF NEEDED
                            else -> {}
                        }
